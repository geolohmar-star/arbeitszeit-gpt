...
class PaperlessWorkflowRegel(models.Model):
    ...
    treffer_typ = models.CharField(
        ...
        help_text="Ob der Name als Paperless-Dokumenttyp, Tag oder OCR-Text-Muster verglichen wird.",
    )
    paperless_name = models.CharField(
        ...
        help_text=(
            ...
            "Beispiel: 'Rechnung' oder 'elektro'. Nicht benoetigt bei Treffer-Typ 'Muster'."
        ),
    )
    muster_regex = models.CharField(
        max_length=500,
        blank=True,
