...
urlpatterns = [
    ...
    path("", views.code_eingabe, name="code_eingabe"),
    ...
    path("hr/codes/", views.hr_einladungscodes, name="hr_einladungscodes"),
    path("hr/<int:pk>/", views.hr_detail, name="hr_detail"),
    path("hr/<int:pk>/speichern/", views.hr_detail_speichern, name="hr_detail_speichern"),
    path("hr/<int:pk>/status-weiter/", views.hr_status_weiter, name="hr_status_weiter"),
    ...
    path("hr/<int:pk>/zusage.docx", views.hr_zusage_docx, name="hr_zusage_docx"),
    path("hr/<int:pk>/absage.docx", views.hr_absage_docx, name="hr_absage_docx"),
